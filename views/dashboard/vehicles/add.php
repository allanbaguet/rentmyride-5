...
<section>
    <form method="POST" enctype="multipart/form-data" novalidate>
        ...
        <div class="mb-3">
            ...
            <input type="text" value="<?=$brand ?? ''?>" pattern="<?=NAME?>" name="brand" class="form-control" id="brand" aria-describedby="brandHelp" required placeholder="Ex: Porsche">
            <div id="brandHelp" class="form-text text-danger"><?= $error['brand'] ?? '' ?></div>
        </div>

        <div class="mb-3">
            <label for="model" class="form-label">Modèle du véhicule*</label>
            <input type="text" value="<?=$model ?? ''?>" pattern="<?=NAME?>" name="model" class="form-control" id="model" aria-describedby="modelHelp" required placeholder="Ex: 911 Carrera">
        ...
        <div class="mb-3">
            ...
            <input type="text" value="<?=$registration ?? ''?>" pattern="<?=REGISTRATION?>" name="registration" class="form-control" id="registration" aria-describedby="registrationHelp" required placeholder="Ex: AA-123-BB">
        ...
        <div class="mb-3">
            ...
            <input type="text" value="<?=$mileage ?? ''?>" pattern="<?=MILEAGE?>" name="mileage" class="form-control" id="mileage" aria-describedby="mileageHelp" required placeholder="Ex: 125000">
